...
public class LRU_lo
	...
	private class CacheObject
		...
		// Constructor
		public CacheObject( long key, Object object )
			{
			this.key = key;
			this.object = object;
			}
	...
	public LRU_lo( long maxCacheSizeInBytes ) throws Throwable
		{
	...
	public Object get( long key )
		...
		count++;
		if ( ( count % 100000 ) == 0 )
			System.out.println( "\t\t\t\tlo cache " + name + ": " + currentCacheSize / 1024 / 1024 + "M / " + maxCacheSize / 1024 / 1024 + "M\t\t" + StringUtils.formatPrice( averageHitRate * 100 ) + "% hit" );
	...
	public static void main( String[] args )
		...
		try
			...
			LRU_lo cache = new LRU_lo( 1000000000 );
